...
namespace ERSA.Mobile.Licenses.ThirdParty
{
    internal static class MicrosoftNETCoreUniversalWindowsPlatform
    {
        public const string License = @"MICROSOFT SOFTWARE LICENSE TERMS
